...
(function()
 {
    ...
    function removeAds() {
        ...
        setInterval(() => {
            ...
            if (isVideoPlayerModified){
                // The player is already modified.
                // The MutationObserver will handle any new videos, so we can avoid this expensive call.
                return;
            }
    ...
    function checkForUpdate(){
        ...
        const scriptUrl = 'https://github.com/TheRealJoelmatic/RemoveAdblockThing/raw/main/Youtube-Ad-blocker-Reminder-Remover.user.js';
